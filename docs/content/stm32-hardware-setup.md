...
Go to the [Initial Setup Guide](content/quadcopter.md#_2-development-environment), select your board STM32, complete initial setup. Once done, follow the verification steps below to ensure everything works.
